...
extern "C"
{
     ...
     * @brief System 业务控制器。
     *
     * Controller 负责组合 System 状态机和 Action Engine，
    ...
    typedef struct
    {
        ...
        /** 负责执行 System Action 的 Action Engine。 */
    ...
    /**
     * @brief 向 System Controller 提交 Request。
     *
     * Controller 会将 Request 交给 System 状态机判断和处理。
     *
    ...
    /**
     * @brief 向 System Controller 提交 Event。
     *
     * Controller 会先让 Action Engine 匹配 Action 的执行结果，
     * 再让 System 状态机根据 Event 更新业务状态。
     *
     * @param controller System Controller。
    ...
    /**
     * @brief 执行一次 System Controller 周期处理。
     *
